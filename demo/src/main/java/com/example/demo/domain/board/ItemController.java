...
@RestController // 변경: 이제 이 클래스는 View 이름을 반환할 수 있습니다.
@RequestMapping("/item")
@AllArgsConstructor
public class ItemController {
    ...
    @ResponseBody
    public List<ItemResponseDto> boardPage(Model model) {
        return itemService.findAll(); // board.html 실행 (ResponseBody가 없어야 함)
    }
    ...
    @ResponseBody
    public ItemResponseDto editPage(@PathVariable Long id) {
